...
import hu.icellmobilsoft.carlosformito.material3demo.ui.common.CarlosTopAppBar
import hu.icellmobilsoft.carlosformito.material3demo.ui.common.SimpleSelectionBottomSheet
import hu.icellmobilsoft.carlosformito.material3demo.ui.fieldsamples.model.PackageType
import hu.icellmobilsoft.carlosformito.ui.field.FormDatePickerField
import hu.icellmobilsoft.carlosformito.ui.field.FormIntegerField
import hu.icellmobilsoft.carlosformito.ui.field.FormPasswordTextField
import hu.icellmobilsoft.carlosformito.ui.field.FormPickerField
import hu.icellmobilsoft.carlosformito.ui.field.FormTextField
import hu.icellmobilsoft.carlosformito.ui.field.FormTimePickerField
...
fun SampleFormScreen(
    ...
    val packageFieldItem = viewModel.getFieldItem<PackageType>(SamplesFormFields.KEY_FORM_FIELD_PACKAGE)
    ...
    Scaffold(
        ...
        Column(
            ...
            FormTextField(
                fieldItem = viewModel.getFieldItem(SamplesFormFields.KEY_FORM_FIELD_NAME),
                label = {
                    Text("Name*")
                },
            ...
            FormPasswordTextField(
                fieldItem = viewModel.getFieldItem(SamplesFormFields.KEY_FORM_FIELD_SECRET),
                label = {
                    Text("Secret*")
                },
            ...
            FormDatePickerField(
                fieldItem = viewModel.getFieldItem(SamplesFormFields.KEY_FORM_FIELD_DATE),
                label = {
                    Text("Date*")
                },
            ...
            FormTimePickerField(
                fieldItem = viewModel.getFieldItem(SamplesFormFields.KEY_FORM_FIELD_TIME),
                label = {
                    Text("Time*")
                },
            ...
            FormIntegerField(
                fieldItem = viewModel.getFieldItem(SamplesFormFields.KEY_FORM_FIELD_SIZE),
                label = {
