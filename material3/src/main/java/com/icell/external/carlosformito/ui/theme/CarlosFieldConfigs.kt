...
class CarlosFieldConfigs(
     ...
     * If not specified, defaults to [OutlinedTextFieldDefaults.shape] or [TextFieldDefaults.shape]
     ...
     * If not specified, defaults to [OutlinedTextFieldDefaults.colors] or [TextFieldDefaults.colors]
     * based on whether the field is outlined or filled.
     */
