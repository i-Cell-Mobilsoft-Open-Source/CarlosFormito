...
fun SetPhoneNumberScreen(
    ...
    val countryItem = viewModel.getFieldItem<Country>(SetPhoneNumberFields.KEY_COUNTRY_CODE)
    ModalBottomSheetLayout(
        ...
        Scaffold(
            ...
            Column(
                ...
                FormTextField(
                    fieldItem = viewModel.getFieldItem(SetPhoneNumberFields.KEY_LOCAL_NUMBER),
                    label = {
                        Text("Phone number*")
                    },
